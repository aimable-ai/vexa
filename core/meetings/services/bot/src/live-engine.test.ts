...
assert.equal(liveEngineForUrl('http://78.46.40.238:8091/v1/audio/transcriptions/live'), 'voxtral', 'audio.cpp path infers HTTP-live without #live');
assert.equal(liveEngineForUrl('http://78.46.40.238:8091/v1/audio/transcriptions/live?model=x'), 'voxtral');
assert.equal(liveEngineForUrl('http://78.46.40.238:8083/v1/audio/transcriptions'), null, 'plain whisper endpoint stays chunked');
